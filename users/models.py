...
class ShoppingCarItem(BaseModel):
    ...
    product = models.ForeignKey(
        to="product.Product", verbose_name=_("Produto"), on_delete=models.CASCADE
    )
    quantity = models.PositiveIntegerField(verbose_name=_("Quantidade"), default=1)
...
class Purchased(BaseModel):
    ...
    quantity = quantity = models.PositiveIntegerField(
        verbose_name=_("Quantidade"), default=1
    )
    ...
    submit_date = models.DateTimeField(
        verbose_name=_("data de pagamento"), blank=True, null=True
    )
