...
class Shop(BaseModel):
    ...
    slug = models.SlugField(
        verbose_name=_("Slug da loja"), unique=True, null=False, blank=False
    )
    ...
    description = models.TextField(
        verbose_name=_("Descrição da loja"), null=True, blank=True
    )
    ...
    views = models.IntegerField(
        verbose_name=_("Visualizações da loja"), default=0, null=True, blank=True
    )
