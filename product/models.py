...
class Product(BaseModel):
    ...
    slug = models.SlugField(
        verbose_name=_("Slug do produto"), unique=True, null=False, blank=False
    )
    ...
    description = models.TextField(
        verbose_name=_("Descrição do produto"), null=False, blank=True
    )
    ...
    views = models.IntegerField(
        verbose_name=_("Visualizações do produto"), default=0, null=True, blank=True
    )
...
class Category(BaseModel):
    ...
    slug = models.SlugField(
        verbose_name=_("Slug da categoria"), unique=True, null=False, blank=False
    )
...
class Evaluation(BaseModel):
    ...
    comment = models.TextField(
        verbose_name=_("Comentário da avaliação"), null=True, blank=True
    )
    ...
    def get_absolute_url(self):
        return reverse(
            "product:evaluations-detail",
            kwargs={"pk": self.pk, "slug": self.product.slug},
        )
...
class Doubt(BaseModel):
    ...
    def get_absolute_url(self):
        return reverse(
            "product:product_doubt_edit",
            kwargs={"id": self.pk, "slug": self.product.slug},
        )
